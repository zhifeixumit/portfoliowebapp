...
viewOpts = ({title:0, page:0, zoom:0, fs:0, pdf:0, toc:0, thumbs:0, progress:1, showbar:1, bg:"#000", loadText:"loading content...", footer:0});
...
function addNavProps(){
	if(nav.numPages === undefined) nav.numPages=217;
